...
<main class="d-flex flex-column align-items-center gap-3 testimonial justify-content-center bg-light p-5">
    <img src="<?php echo BLOGGAR_WP_DIR_URI . '/assets/img/me.jpg'; ?>"
